...
![Project Version-2.0.0](./Images/ProjectVersion-2.0.0.png "Project Version-2.0.0")
...
![Project Version-2.1.0](./Images/ProjectVersion-2.1.0.png "Project Version-2.1.0")
...
![New Projects](./Images/NewProjects.png "New Projects")
...
![Git Process](./Images/git-process.png "Git Process")
...
![Git Parts](./Images/parts_of_git.jpg "Git Parts")
...
![Launch Git Bash](./Images/LaunchGitBash.png "Launch Git Bash")

进入 Git Bash 窗口后可以查看到当前目录的路径，如图所示：

![Git Bash](./Images/GitBash.png "Git Bash")

输入 ``git init`` 初始化仓库，此时工程目录会创建一个 ``.git`` 隐藏文件夹，并且工程路径后会跟随产生 ``master`` 标识，代表目前为 ``master`` 分支（主分支）

![Git Init](./Images/GitInit.png "Git Init")
...
![Git Add](./Images/GitAdd.png "Git Add")
...
![Git Commit](./Images/GitCommit.png "Git Commit")

如上图所示，新文件已经被放入仓库，此时再使用 ``git status`` 查看工作区状态，会发现工作树已经清空

![After Git Commit](./Images/AfterGitCommit.png "After Git Commit")
...
![New Code](./Images/NewCode.png "New Code")
![New Commit](./Images/NewCommit.png "New Commit")
